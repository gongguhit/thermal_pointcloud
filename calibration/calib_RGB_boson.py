...
thermalPixelCoordinate = np.load("/home/gg/Downloads/calibration/test_data/boson_pixel_coordinate.npy")
rgbPixelCoordinate = np.load("/home/gg/Downloads/calibration/test_data/RGB_boson_pixel_coordinate.npy")
...
fund_M = np.array(F)
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Ralative_rotation_matrix.npy",relative_R)
cv_file = cv2.FileStorage("./boson_realsense_Ralative_rotation_matrix.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("boson_realsense_Ralative_rotation_matrix", relative_R)
cv_file.release()
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Ralative_translation_matrix.npy",relative_T)
cv_file = cv2.FileStorage("./boson_realsense_Ralative_translation_matrix.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("boson_realsense_Ralative_translation_matrix", relative_T)
cv_file.release()
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Essential_matrix.npy",essential_M)
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Fundation_matrix.npy",fund_M)
...
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_RGB_intrinsic.npy",rgbIntrinsic)
cv_file = cv2.FileStorage("./boson_realsense_RGB_intrinsic.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("boson_realsense_RGB_intrinsic", rgbIntrinsic)
cv_file.release()
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_RGB_distortion.npy",rgbDistortion)
cv_file = cv2.FileStorage("./boson_realsense_RGB_distortion.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("boson_realsense_RGB_distortion", rgbDistortion)
cv_file.release()
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_RGB_fake_rotation.npy",rgbFakeRotation)
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_RGB_fake_translation.npy",rgbFakeTranslation)
...
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Thermal_intrinsic.npy",thermalIntrinsic)
cv_file = cv2.FileStorage("./boson_realsense_Thermal_intrinsic.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("boson_realsense_Thermal_intrinsic", thermalIntrinsic)
cv_file.release()
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Thermal_distortion.npy",thermalDistortion)
cv_file = cv2.FileStorage("./boson_realsense_Thermal_distortion.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("boson_realsense_Thermal_distortion", thermalDistortion)
cv_file.release()
np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Thermal_fake_rotation.npy",thermalFakeRotation)

np.save("/home/gg/Downloads/calibration/test_data/boson_realsense_Thermal_fake_translation.npy",thermalFakeTranslation)
...
#0224 save intrinsic
fx = float(rgbIntrinsic[0,0])
fy = float(rgbIntrinsic[1,1])
cx = float(rgbIntrinsic[0,2])
cy = float(rgbIntrinsic[1,2])
x = np.arange(0,640)
y = np.arange(0,480)
x_c = np.tile(x, (480, 1))
y_c = np.tile(y,(640,1))
...
cv_file = cv2.FileStorage("./x_real_imgplane.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("x_real_imgplane", x_real_imgplane)
cv_file.release()
cv_file = cv2.FileStorage("./y_real_imgplane.xml",cv2.FILE_STORAGE_WRITE)
cv_file.write("y_real_imgplane", y_real_imgplane)
cv_file.release()

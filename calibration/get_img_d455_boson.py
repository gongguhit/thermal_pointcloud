        ...
        while True :
            ...
            # If RGB and thermal get feature point
                if len(corner_rgb) != 0 and len(Corner_thermal) != 0 :
                    ...
                    cv2.imwrite('/home/gg/Downloads/calibration/test_data/RealSense_RGB'+str(index_p)+'.png', circle_rgb)   #save raw RGB images
                    cv2.imwrite('/home/gg/Downloads/calibration/test_data/boson'+str(index_p)+'.png', circle_thermal)   #save raw thermal images
                    cv2.imwrite('/home/gg/Downloads/calibration/test_data/RealSense_RGB_raw'+str(index_p)+'.png', raw_rgb)
                    cv2.imwrite('/home/gg/Downloads/calibration/test_data/boson_raw'+str(index_p)+'.png', raw_thermal)
                ...
                np.save("/home/gg/Downloads/calibration/test_data/RGB_boson_pixel_coordinate.npy", rgbTwoDPoints)
                thermalTwoDPoints = np.array(thermalTwoDPoints)
                np.save("/home/gg/Downloads/calibration/test_data/boson_pixel_coordinate.npy", thermalTwoDPoints)
                break  
